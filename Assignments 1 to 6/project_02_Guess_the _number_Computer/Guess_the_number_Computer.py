# Guess the Number Game: Computer vs. Player
# Description: A CLI-based game where the computer randomly selects a number between 1 and 99, and the player has to guess it.

import random  # Import random module to generate a random number

def main():
    secret_number = random.randint(1, 99)  # Computer randomly selects a number between 1 and 99
